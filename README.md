...
* Request
  * Method: POST
  * URL: /spotimages/:spotID OR /spot/:spotId/images OR 
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * URL: /reviewimages/reviewId  OR /reviews/:reviewId/images
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * URL: /spotimages/id or /spots/:spotId/spotimages/:spotImageId
  * Body: none
...
* Request
  * Method: DELETE
  * URL: /reviewimages/:reviewimageId  or /reviews/:reviewId/images/:imageId
  * Body: none
